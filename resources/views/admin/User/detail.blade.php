              ...
              <form>
                    ...
                    <div class="col-md-8 col-12">
                      <div class="manage-supplierdetail-profile">
                        ...
                        @if(!empty($Users['photo']))
                      		<img src="{{URL('public/images/'.$Users['photo'])}}"> 
                        @endif
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                      <div class="request-detail-text">{{$Users['username']}}</div>
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4 col-12">
                      <lable class="control-label">Categories:</lable>
                    </div>
                    <div class="col-md-8 col-12">
                      <div class="request-detail-text">          
                        {{ rtrim(implode(' , ', $categoryName), ',') }} 
                      </div>
                    </div>
                  </div>
                </div>
