    ...
    <div class="container-fluid">
      <div class="box-main">
         <div class="box-main-top">
          <div class="box-main-title">Deals List</div>
              ...
              <table class="table table-bordered admin-table dataTable"  id="example2" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$chip->title}}</td>
                      @if($chip->is_url == 1)
                           <td><img width="30px;" src="{{URL('/public/images/'.$chip->imgUrl)}}"> </td> 
                      @else 
                        <td><img width="30px;" src="{{ $chip->imgUrl }}"> </td>    
                      @endif
                    ...
                    <td><!-- <a href=""><i class="fa fa-eye" aria-hidden="true"></i></a> -->
                      <!-- <a href="{{URL('admin/post/detail')}}/{{$chip->id}}">
                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                </a> 
                              &nbsp; -->
                       <a href="{{URL('admin/post/edit')}}/{{$chip->id}}"><i class="fas fa-edit"></i></a>
                              &nbsp;
...
{ 
  $("#LoadingProgress").fadeIn('fast');
    if (confirm('Are you sure you want to delete this Deal?')) {
      ...
      success: function( data, textStatus, jqXHR ) {
        if(data == 0){
          alert('Sorry, this Deal cannot be deleted.');
        }else{
          window.location.reload();
         $("#LoadingProgress").fadeOut('fast');
        }
