...
class UserController extends Controller{
	...
	public function detail(Request $request){
		...
		if(isset($Users->category_id)){
			$category_id = explode(',',$Users->category_id);
			foreach($category_id as $category){
				$category = Categories::where('c_id',$category)->first();
				array_push($categoryName, $category->c_name);
		...
		return view('admin.User.detail',compact('Users','categoryName'));
	}
