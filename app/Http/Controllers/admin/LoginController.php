...
class LoginController extends Controller
{
	...
	public function dashboard(){
		...
		if(session('UserId') == "" || empty(session('UserId'))){
            ...
            $Chips1 		= $CrudRepository->getdashboardDeals($model1,$data);
			...
			return view('admin.dashboard',compact('user_total_count','patner_total_count','customerArr','customerArr1','supplierArr','supplierArr1'));
		}
	}
	...
	public function doforgot(Request $request){
		$rules = array('email'=>'required|email:rfc,dns',
 		...
 		if($validate->fails()){ 		
			...
			if($user['email'] == 'firgun@mailinator.com'){
